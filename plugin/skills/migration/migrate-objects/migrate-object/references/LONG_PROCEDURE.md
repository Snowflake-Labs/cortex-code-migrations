...
| **Dynamic SQL** | EXEC(@sql), EXECUTE IMMEDIATE, sp_executesql | Snowflake EXECUTE IMMEDIATE with bind variables. See [SSC-EWI-0030.md](../../../rule-engine/setup/resolving-ewis/reference/SSC-EWI-0030.md) for conversion reference. |
...
2. **Apply platform-specific transformations** — for dynamic SQL segments, follow the guidance in [SSC-EWI-0030.md](../../../rule-engine/setup/resolving-ewis/reference/SSC-EWI-0030.md)
