...
```
migrate_data(where="source.canonicalName ILIKE '%<SMALL_TABLE_NAME>%'")
```

If successful, return to the parent skill ([migrate_table.md](../actions/migrate_table.md)) to migrate all tables.
