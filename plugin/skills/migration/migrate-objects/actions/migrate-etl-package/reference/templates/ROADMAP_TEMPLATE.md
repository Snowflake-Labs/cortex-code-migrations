...
<!-- TEMPLATE INSTRUCTION (delete after filling):
     ...
     Keep Step {P}.0 as-is — the orchestrator runs it first to create cortex tracking.
     All steps use - [ ] checkboxes. Mark [x] when completed.
     {B} = full batch ID (e.g., B1.1 for Phase 1, Batch 1). Includes phase number. -->

<!-- ═══════════════════════════════════════════════════════════
     TEMPLATE: full-tdd (6 steps: 0-5) — use for phases with type=full-tdd
     ═══════════════════════════════════════════════════════════ -->

- [ ] **Step {P}.0: Initialize Phase Tracking**
```bash
cortex ctx task add "Phase {P}: {PHASE_NAME}"
cortex ctx task start <task_id>
cortex ctx step add "Step {P}.1: Setup (see ROADMAP.md § Phase {P})" -t <task_id>
cortex ctx step add "Step {P}.2: Test-Gen Wave (see ROADMAP.md § Phase {P})" -t <task_id>
cortex ctx step add "Step {P}.3: Fix Wave (see ROADMAP.md § Phase {P})" -t <task_id>
cortex ctx step add "Step {P}.4: Apply-Fixes (see ROADMAP.md § Phase {P})" -t <task_id>
cortex ctx step add "Step {P}.5: Phase Completion (see ROADMAP.md § Phase {P})" -t <task_id>
```
...
Proceed to Phase {NEXT_P} Step {NEXT_P}.0.

<!-- ═══════════════════════════════════════════════════════════
     TEMPLATE: lightweight (5 steps: 0-4) — use for phases with type=lightweight
     ═══════════════════════════════════════════════════════════ -->
...
cortex ctx task start <task_id>
cortex ctx step add "Step {P}.1: Setup (see ROADMAP.md § Phase {P})" -t <task_id>
cortex ctx step add "Step {P}.2: Fix Wave (see ROADMAP.md § Phase {P})" -t <task_id>
cortex ctx step add "Step {P}.3: Apply-Fixes (see ROADMAP.md § Phase {P})" -t <task_id>
cortex ctx step add "Step {P}.4: Phase Completion (see ROADMAP.md § Phase {P})" -t <task_id>
```
...
<!-- ═══════════════════════════════════════════════════════════
     TEMPLATE: dbt (5 steps: 0-4) — use for phases with type=dbt
     ═══════════════════════════════════════════════════════════ -->
...
cortex ctx task start <task_id>
cortex ctx step add "Step {P}.1: Setup (see ROADMAP.md § Phase {P})" -t <task_id>
cortex ctx step add "Step {P}.2: dbt-Test-Gen Wave (see ROADMAP.md § Phase {P})" -t <task_id>
cortex ctx step add "Step {P}.3: dbt-Fix Wave (see ROADMAP.md § Phase {P})" -t <task_id>
cortex ctx step add "Step {P}.4: Phase Completion (see ROADMAP.md § Phase {P})" -t <task_id>
```
...
<!-- TEMPLATE INSTRUCTION (delete after filling):
     Replace all {placeholders} with concrete values. Keep Step {P}.0 as-is.
     All steps use - [ ] checkboxes. Mark [x] when completed. -->

- [ ] **Step {P}.0: Initialize Phase Tracking**
```bash
cortex ctx task add "Phase {P}: Final Validation"
cortex ctx task start <task_id>
cortex ctx step add "Step {P}.1: Validation Checks (see ROADMAP.md § Phase {P})" -t <task_id>
cortex ctx step add "Step {P}.2: Generate Report (see ROADMAP.md § Phase {P})" -t <task_id>
cortex ctx step add "Step {P}.3: Migration Complete (see ROADMAP.md § Phase {P})" -t <task_id>
```
