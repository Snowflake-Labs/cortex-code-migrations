...
Each subdirectory represents a source ETL platform that the migrate-etl-package can process. The orchestrator detects the platform during planning and loads the corresponding profile to configure all platform-specific behavior.
