...
Thin wrapper over `scai assessment effort-estimate`. SCAI reads SnowConvert reports, calculates FDE hours, and writes one timestamped JSON the parent assessment multi-report consumes.
