...
class AnalysisValidatorService:
    ...
    def get_validation_error_message(cls, result: ValidationResult, package_path: str) -> str:
        ...
        lines.extend([
            ...
            "",
            "-" * 70,
            f"READ THE GUIDE provided in the assessment skill for ETL-SSIS: {cls.WRITING_GUIDE_PATH}",
            f"READ THE EXAMPLEs provided in the assessment skill for ETL-SSIS: {cls.EXAMPLE_PATH}",
            "-" * 70,
            "",
        ])
