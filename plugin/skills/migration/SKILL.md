...
**IMPORTANT** Only SQL Server and Redshift projects are currently supported.
...
> 2. **So/mething specific** — tell me what you need"
...
| assessment | Analyze workloads — waves, object exclusion, dynamic SQL, ETL | `./snowconvert-assessment/SKILL.md` |
