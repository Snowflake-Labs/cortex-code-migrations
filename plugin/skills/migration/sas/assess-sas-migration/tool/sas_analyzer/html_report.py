...
a single-file report styled after the Snowflake AIM for Data Warehouses assessment multi-report: a
dark navy sidebar with the Snowflake / Snowflake AIM for Data Warehouses logos and vertical nav,
...
<title>SAS → Snowflake Migration Assessment · Snowflake AIM for Data Warehouses</title>
<style>
...
<div class="app">
  ...
  <main class="main">
    ...
    <div class="content">
      ...
      <footer>Preview — generated by the SAS-to-Snowflake assessment skill (Snowflake AIM for Data Warehouses, tool v{_e(meta['tool_version'])}).
