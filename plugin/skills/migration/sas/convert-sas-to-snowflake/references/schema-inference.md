...
-- Inferred from SAS code: Phase 1 (1-01 through 1-50)
-- Generated by: /convert-sas-to-snowflake Step 7a
-- ============================================================

-- Source: 1-01_Import_Excel_Workpapers.sas (PROC IMPORT, SHEET="Activity_Dimension")
CREATE TABLE IF NOT EXISTS TARGET_SCHEMA.WK_ACTIVITY_DIMENSION (
  ACTIVITY_ID VARCHAR(50),    -- inferred: _ID suffix
  ACTIVITY_NAME VARCHAR(500), -- inferred: _NAME suffix
  COST_CENTER VARCHAR(50),    -- inferred: no format, char context
  HOURS_VR NUMBER(12,2),      -- inferred: subsequent FORMAT 12.2
  HOURS_NVR NUMBER(12,2),     -- inferred: subsequent FORMAT 12.2
  DPE_RATE NUMBER(18,4),      -- inferred: _RATE suffix
  HOURLY_RATE NUMBER(18,4),   -- inferred: _RATE suffix
