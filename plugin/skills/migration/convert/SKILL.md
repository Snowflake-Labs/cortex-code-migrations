---
name: convert
description: Convert extracted source code to Snowflake SQL using SnowConvert. Transforms SQL Server or Redshift code to Snowflake-compatible syntax. Triggers: convert, snowconvert, transform code, convert to snowflake.
